                      ...
                      <div class="col-6">
                        <form method="post">
                          ...
                          <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" autocomplete="off" name="nama" value="<?= $row['nama_lengkap']; ?>" readonly>
                          </div>
                        </div>
                        <div class="col-6">
                          <div class="input-group mb-3">
                            <span class="input-group-text" id="inputGroup-sizing-default">Username</span>
                            <input type="text" class="form-control" autocomplete="off" name="usn" value="<?= $row['username']; ?>" readonly>
                          </div>
                        </div>
                        <div class="col-6">
                          <div class="input-group mb-3">
                        ...
                        <div class="col-12">
                          <div class="input-group mb-3">
                            ...
                            <input type="email" class="form-control" autocomplete="off" name="email" value="<?= $row['email']; ?>" readonly>
                          </div>
                        </div>
                        <div class="col-12">
                          <div class="input-group mb-3">
                            <span class="input-group-text">Alamat</span>
                            <input type="text" class="form-control" autocomplete="off" name="alamat" value="<?= $row['alamat']; ?>" readonly>
                          </div>
                        </div>
                        </div>
                      </form>
